...
def search_sql(name):
    # some sql code to search for person ifno by his name
    info = "person info from sql"
    return info


for indx, row in df.iterrows():
    name = row['name']
    info = search_sql(name)
    
df.to_excel('results\\'+ folder_name+'\\'+ file_name+'.xlsx', index=False)
